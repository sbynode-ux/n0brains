---
title: "S/R Level Watch — August 03, 2026"
description: "BTC at $63,874, ETH at $1,868, SOL at $73.66. Key levels with strength scores and touch counts from n0brains.com Signals Pro."
pubDate: 2026-08-03
...
|-------|-------|------|----------|---------|
| R1 | $64,055 | cme_gap | 0.6 | 3 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $63,870 | resistance | 0.3 | 2 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $1,870 | resistance | 1.0 | 5 |
| R2 | $1,873 | cme_gap | 0.6 | 3 |
| R3 | $1,874 | swing_low | 0.2 | 1 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $1,867 | swing_low | 0.2 | 1 |
| S2 | $1,861 | support | 1.0 | 5 |
| S3 | $1,854 | swing_high | 0.2 | 1 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $73.74 | resistance | 0.6 | 3 |
| R2 | $74.27 | swing_high | 0.2 | 1 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $73.39 | swing_high | 0.2 | 1 |
| S2 | $73.17 | swing_low | 0.2 | 1 |
| S3 | $73.15 | resistance | 0.8 | 8 |
...
S/R levels sourced from the n0brains.com Signals Pro Levels API (`/levels/{coin}`). Computed from Hyperliquid L2 order book data. Strength = normalized score based on touch count, recency, and order book depth at that level. Data pulled at approximately 18:00 UTC on August 03, 2026.
