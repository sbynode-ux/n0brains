---
title: "Smart Money & Whale Watch — June 22, 2026"
...
- **Regime**: risk-off — High real yields (z=2.7) and inverted curve (z=-3.3) driving deterministic risk-off regime.
- **BTC Bias**: bearish at 0.65 conviction
- **ETH Bias**: bearish at 0.75 conviction
- **Key Calendar Risks**: Core PCE Price Index m/m (June 25): Higher than 0.3% could spike real yields, Final GDP q/q (June 25): Disappointing growth may deepen risk-off sentiment
...
Whale and sentiment signals sourced from the n0brains.com Signals Pro API (`/signals`). Whale tracking covers Hyperliquid leaderboard consensus, SOL whale wallets, and on-chain flow detection. Macro context from the n0brains Macro Pulse. Data pulled at approximately 00:00 UTC on June 22, 2026.
