...
description: "BTC at $79,442, ETH at $2,444, SOL at $101.19. Key levels with strength scores and touch counts from n0brains.com Signals Pro."
pubDate: 2026-09-04
...
|-------|-------|------|----------|---------|
| R1 | $79,775 | cme_gap | 0.6 | 3 |
| R2 | $80,255 | swing_low | 0.5 | 1 |
| R3 | $81,391 | resistance | 0.7 | 2 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $101.32 | resistance | 0.4 | 2 |
| R2 | $102.17 | swing_low | 0.3 | 1 |
...
S/R levels sourced from the n0brains.com Signals Pro Levels API (`/levels/{coin}`). Computed from Hyperliquid L2 order book data. Strength = normalized score based on touch count, recency, and order book depth at that level. Data pulled at approximately 18:00 UTC on September 04, 2026.
