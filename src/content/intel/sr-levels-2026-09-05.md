---
title: "S/R Level Watch — September 05, 2026"
description: "BTC at $80,040, ETH at $2,481, SOL at $104.19. Key levels with strength scores and touch counts from n0brains.com Signals Pro."
pubDate: 2026-09-05
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $2,490 | swing_low | 0.2 | 1 |
| R2 | $2,500 | support | 0.6 | 4 |
...
| S2 | $2,447 | support | 1.0 | 5 |
| S3 | $2,434 | swing_low | 0.6 | 1 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $104.28 | resistance | 0.8 | 4 |
| R2 | $104.77 | swing_high | 0.2 | 1 |
| R3 | $105.81 | swing_high | 0.4 | 1 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $103.03 | resistance | 0.6 | 2 |
| S2 | $102.17 | swing_low | 0.4 | 1 |
| S3 | $101.57 | support | 0.8 | 4 |
...
S/R levels sourced from the n0brains.com Signals Pro Levels API (`/levels/{coin}`). Computed from Hyperliquid L2 order book data. Strength = normalized score based on touch count, recency, and order book depth at that level. Data pulled at approximately 18:00 UTC on September 05, 2026.
