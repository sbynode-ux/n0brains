---
title: "Smart Money & Whale Watch — August 02, 2026"
...
- **Regime**: risk-off — Negative net liquidity, rising DXY, and high real yields driving a deterministic risk-off composite (-0.544).
- **BTC Bias**: bearish at 0.65 conviction
- **ETH Bias**: bearish at 0.75 conviction
- **Key Calendar Risks**: Potential liquidity shifts following FOMC press conference fallout, Macro volatility from real yield (real_y10) fluctuations
...
Whale and sentiment signals sourced from the n0brains.com Signals Pro API (`/signals`). Whale tracking covers Hyperliquid leaderboard consensus, SOL whale wallets, and on-chain flow detection. Macro context from the n0brains Macro Pulse. Data pulled at approximately 00:00 UTC on August 02, 2026.
