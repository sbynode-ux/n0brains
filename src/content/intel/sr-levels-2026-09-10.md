...
description: "BTC at $77,298, ETH at $2,465, SOL at $99.94. Key levels with strength scores and touch counts from n0brains.com Signals Pro."
pubDate: 2026-09-10
...
|-------|-------|------|----------|---------|
| R1 | $77,300 | cme_gap | 0.6 | 3 |
| R2 | $77,803 | support | 0.8 | 5 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $2,476 | support | 0.8 | 6 |
| R2 | $2,502 | resistance | 1.0 | 7 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $2,462 | swing_high | 0.5 | 1 |
| S2 | $2,434 | swing_low | 0.6 | 1 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $98.80 | swing_low | 0.2 | 1 |
| S2 | $98.03 | resistance | 0.8 | 2 |
| S3 | $97.35 | swing_low | 0.5 | 1 |
...
S/R levels sourced from the n0brains.com Signals Pro Levels API (`/levels/{coin}`). Computed from Hyperliquid L2 order book data. Strength = normalized score based on touch count, recency, and order book depth at that level. Data pulled at approximately 18:00 UTC on September 10, 2026.
