---
title: "S/R Level Watch — June 13, 2026"
description: "BTC at $63,956, ETH at $1,674, SOL at $67.96. Key levels with strength scores and touch counts from n0brains.com Signals Pro."
pubDate: 2026-06-13
...
|-------|-------|------|----------|---------|
| R1 | $64,093 | swing_high | 0.2 | 1 |
| R2 | $64,358 | resistance | 0.4 | 2 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $63,705 | swing_low | 0.2 | 1 |
| S2 | $63,340 | support | 1.0 | 7 |
| S3 | $63,016 | swing_low | 0.2 | 1 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $1,676 | resistance | 1.0 | 6 |
| R2 | $1,684 | resistance | 0.8 | 4 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $1,668 | support | 0.4 | 2 |
| S2 | $1,661 | support | 1.0 | 6 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $68.19 | swing_high | 0.2 | 1 |
| R2 | $68.74 | resistance | 0.4 | 2 |
...
S/R levels sourced from the n0brains.com Signals Pro Levels API (`/levels/{coin}`). Computed from Hyperliquid L2 order book data. Strength = normalized score based on touch count, recency, and order book depth at that level. Data pulled at approximately 18:00 UTC on June 13, 2026.
