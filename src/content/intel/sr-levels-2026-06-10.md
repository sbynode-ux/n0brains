---
title: "S/R Level Watch — June 10, 2026"
description: "BTC at $61,954, ETH at $1,632, SOL at $64.05. Key levels with strength scores and touch counts from n0brains.com Signals Pro."
pubDate: 2026-06-10
...
|-------|-------|------|----------|---------|
| R1 | $62,343 | resistance | 0.4 | 2 |
| R2 | $62,854 | resistance | 0.4 | 2 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $61,619 | swing_low | 0.2 | 1 |
| S2 | $61,413 | swing_low | 0.2 | 1 |
| S3 | $61,130 | support | 0.6 | 3 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $1,644 | resistance | 0.4 | 2 |
| R2 | $1,665 | resistance | 0.6 | 3 |
| R3 | $1,678 | swing_high | 0.2 | 1 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $1,628 | swing_low | 0.2 | 1 |
| S2 | $1,620 | swing_low | 0.2 | 1 |
| S3 | $1,612 | support | 0.6 | 3 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $64.74 | swing_high | 0.2 | 1 |
| R2 | $65.26 | swing_high | 0.2 | 1 |
| R3 | $65.65 | resistance | 0.6 | 3 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $63.78 | swing_low | 0.2 | 1 |
| S2 | $63.55 | support | 0.4 | 2 |
| S3 | $62.99 | support | 0.4 | 2 |
...
S/R levels sourced from the n0brains.com Signals Pro Levels API (`/levels/{coin}`). Computed from Hyperliquid L2 order book data. Strength = normalized score based on touch count, recency, and order book depth at that level. Data pulled at approximately 18:00 UTC on June 10, 2026.
