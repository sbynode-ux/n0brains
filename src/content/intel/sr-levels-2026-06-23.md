---
title: "S/R Level Watch — June 23, 2026"
description: "BTC at $62,330, ETH at $1,656, SOL at $68.72. Key levels with strength scores and touch counts from n0brains.com Signals Pro."
pubDate: 2026-06-23
...
|-------|-------|------|----------|---------|
| R1 | $62,532 | swing_low | 0.2 | 1 |
| R2 | $62,743 | resistance | 0.6 | 3 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $62,180 | support | 0.4 | 2 |
| S2 | $61,918 | support | 0.4 | 2 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $1,662 | swing_high | 0.2 | 1 |
| R2 | $1,673 | resistance | 0.4 | 2 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $1,651 | swing_low | 0.2 | 1 |
| S2 | $1,644 | swing_low | 0.2 | 1 |
| S3 | $1,634 | swing_low | 0.2 | 1 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $69.33 | resistance | 0.4 | 2 |
| R2 | $69.61 | swing_high | 0.2 | 1 |
| R3 | $69.63 | swing_low | 0.2 | 1 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $68.46 | support | 0.6 | 3 |
| S2 | $68.06 | swing_low | 0.2 | 1 |
...
S/R levels sourced from the n0brains.com Signals Pro Levels API (`/levels/{coin}`). Computed from Hyperliquid L2 order book data. Strength = normalized score based on touch count, recency, and order book depth at that level. Data pulled at approximately 18:00 UTC on June 23, 2026.
