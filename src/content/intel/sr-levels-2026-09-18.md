---
title: "S/R Level Watch — September 18, 2026"
description: "BTC at $81,036, ETH at $2,608, SOL at $112.64. Key levels with strength scores and touch counts from n0brains.com Signals Pro."
pubDate: 2026-09-18
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $80,940 | cme_gap | 0.8 | 3 |
| S2 | $80,255 | swing_low | 0.4 | 1 |
| S3 | $79,434 | swing_high | 0.5 | 1 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $2,613 | support | 0.9 | 2 |
| R2 | $2,651 | resistance | 1.0 | 2 |
| R3 | $2,718 | swing_low | 0.4 | 1 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $2,596 | cme_gap | 0.8 | 3 |
| S2 | $2,547 | resistance | 0.9 | 5 |
| S3 | $2,521 | swing_low | 0.5 | 1 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $116.82 | swing_low | 0.4 | 1 |
| R2 | $119.66 | support | 0.7 | 2 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $112.15 | swing_low | 0.4 | 1 |
| S2 | $110.93 | swing_high | 0.5 | 1 |
| S3 | $107.34 | swing_high | 0.5 | 1 |
...
S/R levels sourced from the n0brains.com Signals Pro Levels API (`/levels/{coin}`). Computed from Hyperliquid L2 order book data. Strength = normalized score based on touch count, recency, and order book depth at that level. Data pulled at approximately 18:00 UTC on September 18, 2026.
