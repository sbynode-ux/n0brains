---
title: "S/R Level Watch — June 04, 2026"
description: "BTC at $63,202, ETH at $1,765, SOL at $69.11. Key levels with strength scores and touch counts from n0brains.com Signals Pro."
pubDate: 2026-06-04
...
|-------|-------|------|----------|---------|
| R1 | $64,466 | resistance | 0.4 | 2 |
| R2 | $64,752 | swing_high | 0.2 | 1 |
| R3 | $65,853 | swing_high | 0.2 | 1 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $62,160 | swing_low | 0.2 | 1 |
| S2 | $61,350 | swing_low | 0.2 | 1 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $1,794 | swing_high | 0.2 | 1 |
| R2 | $1,818 | swing_high | 0.2 | 1 |
| R3 | $1,838 | swing_high | 0.2 | 1 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $1,729 | swing_low | 0.2 | 1 |
| S2 | $1,717 | swing_low | 0.2 | 1 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $70.61 | swing_high | 0.2 | 1 |
| R2 | $71.18 | swing_high | 0.2 | 1 |
| R3 | $71.72 | swing_high | 0.2 | 1 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $67.36 | swing_low | 0.2 | 1 |
| S2 | $66.67 | swing_low | 0.2 | 1 |
...
S/R levels sourced from the n0brains.com Signals Pro Levels API (`/levels/{coin}`). Computed from Hyperliquid L2 order book data. Strength = normalized score based on touch count, recency, and order book depth at that level. Data pulled at approximately 17:24 UTC on June 04, 2026.
