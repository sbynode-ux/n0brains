---
title: "S/R Level Watch — September 07, 2026"
description: "BTC at $79,148, ETH at $2,495, SOL at $103.94. Key levels with strength scores and touch counts from n0brains.com Signals Pro."
pubDate: 2026-09-07
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $78,600 | swing_low | 0.4 | 1 |
| S2 | $78,271 | swing_low | 0.4 | 1 |
| S3 | $77,140 | support | 1.0 | 3 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $2,500 | resistance | 1.0 | 5 |
| R2 | $2,521 | swing_low | 0.5 | 1 |
| R3 | $2,548 | resistance | 1.0 | 4 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $2,488 | support | 1.0 | 6 |
| S2 | $2,474 | support | 0.4 | 2 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $104.30 | swing_high | 0.2 | 1 |
| R2 | $105.81 | swing_high | 0.4 | 1 |
| R3 | $106.41 | resistance | 0.4 | 2 |
...
S/R levels sourced from the n0brains.com Signals Pro Levels API (`/levels/{coin}`). Computed from Hyperliquid L2 order book data. Strength = normalized score based on touch count, recency, and order book depth at that level. Data pulled at approximately 18:00 UTC on September 07, 2026.
