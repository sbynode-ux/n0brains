---
title: "S/R Level Watch — June 22, 2026"
description: "BTC at $64,586, ETH at $1,741, SOL at $73.25. Key levels with strength scores and touch counts from n0brains.com Signals Pro."
pubDate: 2026-06-22
...
|-------|-------|------|----------|---------|
| R1 | $64,775 | swing_high | 0.2 | 1 |
| R2 | $65,587 | swing_high | 0.2 | 1 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $64,555 | swing_high | 0.2 | 1 |
| S2 | $64,341 | resistance | 0.8 | 7 |
| S3 | $64,199 | support | 0.4 | 2 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $1,748 | resistance | 0.4 | 2 |
| R2 | $1,759 | swing_high | 0.2 | 1 |
| R3 | $1,776 | resistance | 0.4 | 2 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $1,739 | resistance | 0.8 | 5 |
| S2 | $1,732 | resistance | 0.8 | 5 |
| S3 | $1,732 | support | 0.6 | 3 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $73.26 | swing_low | 0.2 | 1 |
| R2 | $73.44 | swing_high | 0.2 | 1 |
| R3 | $73.54 | support | 0.3 | 2 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $72.93 | support | 0.6 | 3 |
| S2 | $72.64 | support | 0.4 | 2 |
| S3 | $72.55 | resistance | 0.3 | 2 |
...
S/R levels sourced from the n0brains.com Signals Pro Levels API (`/levels/{coin}`). Computed from Hyperliquid L2 order book data. Strength = normalized score based on touch count, recency, and order book depth at that level. Data pulled at approximately 18:00 UTC on June 22, 2026.
