---
title: "S/R Level Watch — June 03, 2026"
description: "BTC at $65,950, ETH at $1,827, SOL at $73.14. Key levels with strength scores and touch counts from n0brains.com Signals Pro."
pubDate: 2026-06-03
...
|-------|-------|------|----------|---------|
| R1 | $67,192 | resistance | 0.4 | 2 |
| R2 | $67,460 | resistance | 0.4 | 2 |
| R3 | $67,899 | swing_high | 0.2 | 1 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $65,476 | support | 0.4 | 2 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $1,873 | swing_high | 0.2 | 1 |
| R2 | $1,884 | swing_high | 0.2 | 1 |
| R3 | $1,892 | swing_high | 0.2 | 1 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $1,816 | swing_low | 0.2 | 1 |
| S2 | $1,810 | swing_low | 0.2 | 1 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $75.09 | swing_high | 0.2 | 1 |
| R2 | $75.37 | resistance | 0.4 | 2 |
| R3 | $75.69 | swing_high | 0.2 | 1 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $72.68 | swing_low | 0.2 | 1 |
| S2 | $72.23 | swing_low | 0.2 | 1 |
| S3 | $71.98 | swing_low | 0.2 | 1 |
...
S/R levels sourced from the n0brains.com Signals Pro Levels API (`/levels/{coin}`). Computed from Hyperliquid L2 order book data. Strength = normalized score based on touch count, recency, and order book depth at that level. Data pulled at approximately 18:00 UTC on June 03, 2026.
