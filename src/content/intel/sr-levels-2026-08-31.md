---
title: "S/R Level Watch — August 31, 2026"
description: "BTC at $78,886, ETH at $2,476, SOL at $103.61. Key levels with strength scores and touch counts from n0brains.com Signals Pro."
pubDate: 2026-08-31
...
| R2 | $80,255 | swing_low | 0.4 | 1 |
| R3 | $81,391 | resistance | 0.6 | 2 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $78,690 | support | 0.4 | 2 |
| S2 | $78,271 | swing_low | 0.5 | 1 |
| S3 | $77,913 | support | 1.0 | 7 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $2,480 | cme_gap | 0.6 | 3 |
| R2 | $2,521 | swing_low | 0.4 | 1 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $104.10 | resistance | 1.0 | 7 |
| R2 | $105.37 | resistance | 0.8 | 4 |
| R3 | $107.42 | swing_high | 0.4 | 1 |
...
| S2 | $100.84 | swing_low | 0.2 | 1 |
| S3 | $100.28 | swing_low | 0.4 | 1 |
...
S/R levels sourced from the n0brains.com Signals Pro Levels API (`/levels/{coin}`). Computed from Hyperliquid L2 order book data. Strength = normalized score based on touch count, recency, and order book depth at that level. Data pulled at approximately 18:00 UTC on August 31, 2026.
