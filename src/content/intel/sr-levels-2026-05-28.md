---
title: "S/R Level Watch — May 28, 2026"
description: "BTC at $73,516, ETH at $2,019, SOL at $82.25. Key levels with strength scores and touch counts from n0brains.com Signals Pro."
pubDate: 2026-05-28
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $73,175 | swing_low | 0.2 | 1 |
| S2 | $72,656 | support | 0.6 | 3 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $2,065 | swing_high | 0.2 | 1 |
| R2 | $2,080 | resistance | 0.8 | 4 |
| R3 | $2,096 | resistance | 0.4 | 2 |
...
| S2 | $1,984 | swing_low | 0.2 | 1 |
| S3 | $1,968 | support | 0.6 | 3 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $82.04 | support | 0.6 | 3 |
| S2 | $79.97 | support | 0.4 | 2 |
...
S/R levels sourced from the n0brains.com Signals Pro Levels API (`/levels/{coin}`). Computed from Hyperliquid L2 order book data. Strength = normalized score based on touch count, recency, and order book depth at that level. Data pulled at approximately 18:00 UTC on May 28, 2026.
