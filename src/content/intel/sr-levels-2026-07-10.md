---
title: "S/R Level Watch — July 10, 2026"
description: "BTC at $63,816, ETH at $1,788, SOL at $77.55. Key levels with strength scores and touch counts from n0brains.com Signals Pro."
pubDate: 2026-07-10
...
|-------|-------|------|----------|---------|
| R1 | $64,119 | resistance | 0.4 | 2 |
| R2 | $64,130 | cme_gap | 0.6 | 3 |
| R3 | $64,598 | resistance | 0.6 | 3 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $63,810 | support | 0.6 | 3 |
| S2 | $63,750 | swing_high | 0.2 | 1 |
| S3 | $63,344 | resistance | 0.8 | 6 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $1,798 | cme_gap | 0.6 | 3 |
| R2 | $1,805 | resistance | 0.4 | 2 |
| R3 | $1,812 | swing_high | 0.2 | 1 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $1,785 | swing_low | 0.2 | 1 |
| S2 | $1,785 | swing_high | 0.2 | 1 |
| S3 | $1,779 | resistance | 0.5 | 3 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $77.61 | resistance | 0.6 | 3 |
| R2 | $77.80 | support | 0.3 | 2 |
| R3 | $78.17 | swing_low | 0.2 | 1 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $77.24 | support | 0.8 | 4 |
| S2 | $76.79 | support | 1.0 | 6 |
...
S/R levels sourced from the n0brains.com Signals Pro Levels API (`/levels/{coin}`). Computed from Hyperliquid L2 order book data. Strength = normalized score based on touch count, recency, and order book depth at that level. Data pulled at approximately 18:00 UTC on July 10, 2026.
