---
title: "S/R Level Watch — August 13, 2026"
description: "BTC at $63,128, ETH at $1,876, SOL at $75.73. Key levels with strength scores and touch counts from n0brains.com Signals Pro."
pubDate: 2026-08-13
...
|-------|-------|------|----------|---------|
| R1 | $64,804 | resistance | 1.0 | 3 |
| R2 | $66,908 | resistance | 1.0 | 3 |
| R3 | $70,263 | resistance | 0.9 | 2 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $62,816 | swing_low | 0.2 | 1 |
| S2 | $62,352 | support | 1.0 | 2 |
| S3 | $61,593 | support | 1.0 | 5 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $1,874 | swing_low | 0.4 | 1 |
| S2 | $1,852 | resistance | 1.0 | 3 |
| S3 | $1,809 | support | 1.0 | 2 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $76.27 | support | 1.0 | 3 |
| R2 | $77.69 | resistance | 1.0 | 4 |
| R3 | $80.77 | support | 0.8 | 2 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $75.50 | resistance | 0.8 | 2 |
| S2 | $74.65 | resistance | 0.9 | 6 |
| S3 | $73.33 | swing_low | 0.5 | 1 |
...
S/R levels sourced from the n0brains.com Signals Pro Levels API (`/levels/{coin}`). Computed from Hyperliquid L2 order book data. Strength = normalized score based on touch count, recency, and order book depth at that level. Data pulled at approximately 18:00 UTC on August 13, 2026.
