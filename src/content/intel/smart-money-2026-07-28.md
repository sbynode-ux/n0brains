---
title: "Smart Money & Whale Watch — July 28, 2026"
description: "Macro regime: risk-off. BTC bias: neutral (0.4 conviction). 1 whale/sentiment signals, 0 high-conviction signals. Data from n0brains.com Signals Pro."
pubDate: 2026-07-28
...
|-----|-------|------|---------|-------|-------|------|
| 🟢 | BTC | sentiment | CoinGecko trending list shows several assets with positive price actio | N/A | 0.2 | 65% |
...
1. **Sentiment on BTC**: CoinGecko trending list shows several assets with positive price action, notably COTI (+67.5%).
...
Whale and sentiment signals sourced from the n0brains.com Signals Pro API (`/signals`). Whale tracking covers Hyperliquid leaderboard consensus, SOL whale wallets, and on-chain flow detection. Macro context from the n0brains Macro Pulse. Data pulled at approximately 00:00 UTC on July 28, 2026.
