...
description: "BTC at $64,298, ETH at $1,875, SOL at $74.04. Key levels with strength scores and touch counts from n0brains.com Signals Pro."
pubDate: 2026-08-05
...
|-------|-------|------|----------|---------|
| R1 | $64,486 | resistance | 0.6 | 3 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $64,285 | cme_gap | 0.8 | 3 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $1,883 | resistance | 0.6 | 3 |
| R2 | $1,899 | swing_high | 0.2 | 1 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $1,875 | resistance | 0.8 | 9 |
| S2 | $1,874 | cme_gap | 0.8 | 3 |
| S3 | $1,864 | resistance | 0.3 | 2 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $74.20 | resistance | 1.0 | 9 |
| R2 | $74.45 | resistance | 0.4 | 2 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $73.85 | swing_low | 0.2 | 1 |
| S2 | $73.76 | resistance | 0.8 | 5 |
| S3 | $73.59 | swing_low | 0.2 | 1 |
...
S/R levels sourced from the n0brains.com Signals Pro Levels API (`/levels/{coin}`). Computed from Hyperliquid L2 order book data. Strength = normalized score based on touch count, recency, and order book depth at that level. Data pulled at approximately 13:00 UTC on August 05, 2026.
