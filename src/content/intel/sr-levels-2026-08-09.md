---
title: "S/R Level Watch — August 09, 2026"
description: "BTC at $65,162, ETH at $1,923, SOL at $77.18. Key levels with strength scores and touch counts from n0brains.com Signals Pro."
pubDate: 2026-08-09
...
|-------|-------|------|----------|---------|
| R1 | $65,210 | cme_gap | 0.6 | 3 |
| R2 | $65,311 | resistance | 0.4 | 2 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $65,148 | swing_low | 0.2 | 1 |
| S2 | $65,020 | resistance | 0.8 | 12 |
| S3 | $64,838 | support | 1.0 | 12 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $1,923 | cme_gap | 0.6 | 3 |
| R2 | $1,926 | resistance | 0.6 | 3 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $1,920 | support | 0.6 | 3 |
| S2 | $1,919 | resistance | 0.8 | 11 |
| S3 | $1,912 | support | 1.0 | 10 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $77.56 | swing_high | 0.2 | 1 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $76.76 | swing_high | 0.2 | 1 |
| S2 | $76.51 | resistance | 0.6 | 4 |
| S3 | $76.22 | support | 0.8 | 4 |
...
S/R levels sourced from the n0brains.com Signals Pro Levels API (`/levels/{coin}`). Computed from Hyperliquid L2 order book data. Strength = normalized score based on touch count, recency, and order book depth at that level. Data pulled at approximately 18:00 UTC on August 09, 2026.
