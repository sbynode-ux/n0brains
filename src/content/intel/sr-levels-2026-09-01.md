---
title: "S/R Level Watch — September 01, 2026"
description: "BTC at $77,238, ETH at $2,418, SOL at $100.50. Key levels with strength scores and touch counts from n0brains.com Signals Pro."
pubDate: 2026-09-01
...
|-------|-------|------|----------|---------|
| R1 | $77,394 | support | 0.3 | 2 |
| R2 | $78,271 | swing_low | 0.5 | 1 |
| R3 | $78,882 | resistance | 0.6 | 3 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $77,140 | support | 1.0 | 3 |
| S2 | $76,526 | swing_low | 0.4 | 1 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $2,434 | swing_low | 0.5 | 1 |
| R2 | $2,464 | resistance | 1.0 | 2 |
| R3 | $2,476 | resistance | 0.4 | 2 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $2,404 | resistance | 0.9 | 2 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $100.98 | support | 0.5 | 3 |
| R2 | $101.75 | swing_low | 0.2 | 1 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $100.28 | swing_low | 0.4 | 1 |
| S2 | $98.03 | resistance | 0.7 | 2 |
...
S/R levels sourced from the n0brains.com Signals Pro Levels API (`/levels/{coin}`). Computed from Hyperliquid L2 order book data. Strength = normalized score based on touch count, recency, and order book depth at that level. Data pulled at approximately 18:00 UTC on September 01, 2026.
