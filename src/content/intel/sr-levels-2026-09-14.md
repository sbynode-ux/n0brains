---
title: "S/R Level Watch — September 14, 2026"
description: "BTC at $78,930, ETH at $2,533, SOL at $103.02. Key levels with strength scores and touch counts from n0brains.com Signals Pro."
pubDate: 2026-09-14
...
|-------|-------|------|----------|---------|
| R1 | $78,980 | cme_gap | 0.6 | 3 |
| R2 | $79,434 | swing_high | 0.5 | 1 |
| R3 | $80,255 | swing_low | 0.4 | 1 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $78,271 | swing_low | 0.6 | 1 |
| S2 | $77,887 | resistance | 0.5 | 3 |
| S3 | $77,259 | support | 1.0 | 4 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $2,547 | resistance | 1.0 | 5 |
| R2 | $2,613 | support | 0.7 | 2 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $2,521 | swing_low | 0.5 | 1 |
| S2 | $2,487 | swing_low | 0.2 | 1 |
| S3 | $2,462 | swing_high | 0.6 | 1 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $103.03 | resistance | 0.6 | 2 |
| R2 | $105.58 | resistance | 1.0 | 3 |
| R3 | $107.34 | swing_high | 0.5 | 1 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $103.01 | swing_high | 0.2 | 1 |
| S2 | $102.35 | resistance | 0.6 | 4 |
| S3 | $101.93 | support | 0.7 | 2 |
...
S/R levels sourced from the n0brains.com Signals Pro Levels API (`/levels/{coin}`). Computed from Hyperliquid L2 order book data. Strength = normalized score based on touch count, recency, and order book depth at that level. Data pulled at approximately 18:00 UTC on September 14, 2026.
