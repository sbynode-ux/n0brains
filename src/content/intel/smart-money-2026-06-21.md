---
title: "Smart Money & Whale Watch — June 21, 2026"
...
- **Regime**: risk-off — High real yields (z=2.7) and steep curve flattening driving a negative deterministic composite (-0.618).
- **BTC Bias**: bearish at 0.65 conviction
- **ETH Bias**: bearish at 0.75 conviction
- **Key Calendar Risks**: UN Security Council meeting on Ukraine (June 22), Annual bank stress test results release (June 24)
...
Whale and sentiment signals sourced from the n0brains.com Signals Pro API (`/signals`). Whale tracking covers Hyperliquid leaderboard consensus, SOL whale wallets, and on-chain flow detection. Macro context from the n0brains Macro Pulse. Data pulled at approximately 00:00 UTC on June 21, 2026.
