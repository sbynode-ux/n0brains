---
title: "Smart Money & Whale Watch — July 23, 2026"
description: "Macro regime: range. BTC bias: neutral (0.45 conviction). 1 whale/sentiment signals, 0 high-conviction signals. Data from n0brains.com Signals Pro."
pubDate: 2026-07-23
...
|-----|-------|------|---------|-------|-------|------|
| 🟢 | BTC | sentiment | Alphabet's Q2 revenue beats estimates. | N/A | 1.3 | 65% |
...
- **Regime**: range — Deterministic composite score -0.217 driven by high real yields (real_y10) offsetting net liquidity gains.
- **BTC Bias**: neutral at 0.45 conviction
- **ETH Bias**: bearish at 0.55 conviction
- **Key Calendar Risks**: Geopolitical escalation regarding Iran/Trump comments, Potential liquidity shifts from USDT treasury redemptions

## Key Takeaways

1. **Sentiment on BTC**: Alphabet's Q2 revenue beats estimates.
...
Whale and sentiment signals sourced from the n0brains.com Signals Pro API (`/signals`). Whale tracking covers Hyperliquid leaderboard consensus, SOL whale wallets, and on-chain flow detection. Macro context from the n0brains Macro Pulse. Data pulled at approximately 00:00 UTC on July 23, 2026.
