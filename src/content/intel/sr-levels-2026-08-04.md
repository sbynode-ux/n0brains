---
title: "S/R Level Watch — August 04, 2026"
description: "BTC at $63,944, ETH at $1,869, SOL at $73.74. Key levels with strength scores and touch counts from n0brains.com Signals Pro."
pubDate: 2026-08-04
...
|-------|-------|------|----------|---------|
| R1 | $63,951 | resistance | 1.0 | 5 |
| R2 | $64,208 | resistance | 0.4 | 2 |
| R3 | $64,295 | cme_gap | 0.6 | 3 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $63,666 | support | 0.8 | 4 |
| S2 | $63,578 | resistance | 0.8 | 5 |
| S3 | $63,391 | support | 0.8 | 4 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $1,874 | swing_low | 0.2 | 1 |
| R2 | $1,875 | resistance | 1.0 | 7 |
| R3 | $1,878 | cme_gap | 0.6 | 3 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $1,866 | swing_low | 0.2 | 1 |
| S2 | $1,864 | resistance | 0.3 | 2 |
| S3 | $1,859 | support | 0.8 | 4 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $74.15 | resistance | 1.0 | 5 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $73.74 | resistance | 0.8 | 6 |
| S2 | $73.45 | swing_low | 0.2 | 1 |
| S3 | $73.30 | resistance | 0.5 | 3 |
...
S/R levels sourced from the n0brains.com Signals Pro Levels API (`/levels/{coin}`). Computed from Hyperliquid L2 order book data. Strength = normalized score based on touch count, recency, and order book depth at that level. Data pulled at approximately 18:00 UTC on August 04, 2026.
