---
title: "S/R Level Watch — August 10, 2026"
description: "BTC at $63,934, ETH at $1,873, SOL at $75.98. Key levels with strength scores and touch counts from n0brains.com Signals Pro."
pubDate: 2026-08-10
...
|-------|-------|------|----------|---------|
| R1 | $64,500 | swing_low | 0.2 | 1 |
| R2 | $64,775 | cme_gap | 0.6 | 3 |
| R3 | $64,849 | support | 0.8 | 14 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $1,905 | swing_low | 0.2 | 1 |
| R2 | $1,914 | support | 0.8 | 12 |
| R3 | $1,920 | resistance | 1.0 | 10 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $1,872 | cme_gap | 0.8 | 3 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $76.12 | swing_high | 0.2 | 1 |
| R2 | $76.25 | support | 0.8 | 6 |
| R3 | $76.51 | resistance | 0.8 | 4 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $75.78 | support | 1.0 | 6 |
| S2 | $75.67 | swing_high | 0.2 | 1 |
| S3 | $75.11 | swing_high | 0.2 | 1 |
...
S/R levels sourced from the n0brains.com Signals Pro Levels API (`/levels/{coin}`). Computed from Hyperliquid L2 order book data. Strength = normalized score based on touch count, recency, and order book depth at that level. Data pulled at approximately 18:00 UTC on August 10, 2026.
