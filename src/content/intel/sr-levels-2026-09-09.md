---
title: "S/R Level Watch — September 09, 2026"
description: "BTC at $78,766, ETH at $2,493, SOL at $103.48. Key levels with strength scores and touch counts from n0brains.com Signals Pro."
pubDate: 2026-09-09
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $2,501 | resistance | 1.0 | 8 |
| R2 | $2,521 | swing_low | 0.5 | 1 |
| R3 | $2,547 | resistance | 1.0 | 5 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $2,478 | support | 1.0 | 7 |
| S2 | $2,462 | swing_high | 0.5 | 1 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $103.61 | support | 0.6 | 4 |
| R2 | $105.81 | swing_high | 0.4 | 1 |
| R3 | $106.27 | swing_high | 0.2 | 1 |
...
S/R levels sourced from the n0brains.com Signals Pro Levels API (`/levels/{coin}`). Computed from Hyperliquid L2 order book data. Strength = normalized score based on touch count, recency, and order book depth at that level. Data pulled at approximately 18:00 UTC on September 09, 2026.
