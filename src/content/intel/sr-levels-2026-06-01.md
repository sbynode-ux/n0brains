---
title: "S/R Level Watch — June 01, 2026"
description: "BTC at $71,648, ETH at $1,990, SOL at $80.91. Key levels with strength scores and touch counts from n0brains.com Signals Pro."
pubDate: 2026-06-01
...
|-------|-------|------|----------|---------|
| R1 | $73,090 | swing_high | 0.2 | 1 |
| R2 | $73,715 | resistance | 0.8 | 4 |
| R3 | $74,086 | resistance | 1.0 | 10 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $71,327 | swing_low | 0.2 | 1 |
| S2 | $70,683 | swing_low | 0.2 | 1 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $1,992 | resistance | 0.4 | 2 |
| R2 | $2,007 | swing_high | 0.2 | 1 |
| R3 | $2,021 | resistance | 1.0 | 9 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $1,969 | support | 0.4 | 2 |
| S2 | $1,956 | support | 0.4 | 2 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $81.21 | resistance | 0.4 | 2 |
| R2 | $81.88 | swing_high | 0.2 | 1 |
| R3 | $82.44 | resistance | 0.4 | 2 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $80.42 | swing_low | 0.2 | 1 |
| S2 | $79.19 | support | 0.4 | 2 |
...
S/R levels sourced from the n0brains.com Signals Pro Levels API (`/levels/{coin}`). Computed from Hyperliquid L2 order book data. Strength = normalized score based on touch count, recency, and order book depth at that level. Data pulled at approximately 18:00 UTC on June 01, 2026.
