---
title: "S/R Level Watch — August 02, 2026"
description: "BTC at $63,296, ETH at $1,868, SOL at $73.28. Key levels with strength scores and touch counts from n0brains.com Signals Pro."
pubDate: 2026-08-02
...
|-------|-------|------|----------|---------|
| R1 | $63,564 | resistance | 0.6 | 3 |
| R2 | $63,582 | swing_low | 0.2 | 1 |
| R3 | $63,895 | resistance | 0.4 | 2 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $63,279 | swing_high | 0.2 | 1 |
| S2 | $63,130 | cme_gap | 0.8 | 3 |
| S3 | $63,068 | resistance | 0.8 | 7 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $1,869 | resistance | 0.8 | 4 |
| R2 | $1,872 | cme_gap | 0.6 | 3 |
| R3 | $1,875 | support | 0.3 | 2 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $1,863 | support | 1.0 | 6 |
| S2 | $1,849 | support | 0.6 | 3 |
| S3 | $1,848 | swing_high | 0.2 | 1 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $73.38 | support | 0.5 | 3 |
| R2 | $73.41 | resistance | 0.4 | 2 |
| R3 | $73.70 | swing_low | 0.2 | 1 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $73.15 | resistance | 0.8 | 8 |
| S2 | $72.79 | support | 1.0 | 11 |
| S3 | $71.79 | swing_low | 0.2 | 1 |
...
S/R levels sourced from the n0brains.com Signals Pro Levels API (`/levels/{coin}`). Computed from Hyperliquid L2 order book data. Strength = normalized score based on touch count, recency, and order book depth at that level. Data pulled at approximately 18:00 UTC on August 02, 2026.
