---
title: "S/R Level Watch — May 25, 2026"
description: "BTC at $77,526, ETH at $2,128, SOL at $86.06. Key levels with strength scores and touch counts from n0brains.com Signals Pro."
pubDate: 2026-05-25
...
|-------|-------|------|----------|---------|
| R1 | $77,865 | swing_high | 0.2 | 1 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $77,464 | swing_low | 0.2 | 1 |
| S2 | $77,102 | support | 0.6 | 3 |
| S3 | $76,703 | support | 0.8 | 4 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $2,130 | resistance | 0.4 | 2 |
| R2 | $2,137 | swing_high | 0.2 | 1 |
| R3 | $2,149 | swing_high | 0.2 | 1 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $2,113 | support | 0.8 | 4 |
| S2 | $2,100 | support | 0.4 | 2 |
| S3 | $2,091 | support | 0.4 | 2 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $86.15 | resistance | 0.8 | 4 |
| R2 | $86.57 | resistance | 0.4 | 2 |
| R3 | $86.93 | resistance | 0.4 | 2 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $86.05 | support | 0.6 | 3 |
| S2 | $85.58 | support | 1.0 | 7 |
| S3 | $84.76 | support | 0.4 | 2 |
...
S/R levels sourced from the n0brains.com Signals Pro Levels API (`/levels/{coin}`). Computed from Hyperliquid L2 order book data. Strength = normalized score based on touch count, recency, and order book depth at that level. Data pulled at approximately 18:00 UTC on May 25, 2026.
