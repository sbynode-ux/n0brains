...
description: "BTC at $77,306, ETH at $2,115, SOL at $85.81. Key levels with strength scores and touch counts from n0brains.com Signals Pro."
pubDate: 2026-05-25
...
|-------|-------|------|----------|---------|
| R1 | $77,524 | resistance | 1.0 | 5 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $76,978 | support | 0.6 | 3 |
| S2 | $76,564 | support | 1.0 | 5 |
| S3 | $76,073 | support | 0.4 | 2 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $2,122 | resistance | 1.0 | 5 |
| R2 | $2,130 | resistance | 0.6 | 3 |
...
| R2 | $86.84 | resistance | 0.6 | 3 |
| R3 | $87.15 | swing_high | 0.2 | 1 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $85.53 | support | 1.0 | 5 |
| S2 | $84.76 | support | 0.4 | 2 |
| S3 | $84.42 | swing_low | 0.2 | 1 |
...
S/R levels sourced from the n0brains.com Signals Pro Levels API (`/levels/{coin}`). Computed from Hyperliquid L2 order book data. Strength = normalized score based on touch count, recency, and order book depth at that level. Data pulled at approximately 13:00 UTC on May 25, 2026.
