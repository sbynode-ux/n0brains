---
title: "S/R Level Watch — September 13, 2026"
description: "BTC at $77,304, ETH at $2,505, SOL at $100.97. Key levels with strength scores and touch counts from n0brains.com Signals Pro."
pubDate: 2026-09-13
...
|-------|-------|------|----------|---------|
| R1 | $77,353 | resistance | 1.0 | 13 |
| R2 | $78,271 | swing_low | 0.4 | 1 |
| R3 | $78,600 | swing_low | 0.3 | 1 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $77,259 | support | 1.0 | 4 |
| S2 | $76,380 | support | 1.0 | 2 |
| S3 | $75,972 | swing_high | 0.6 | 1 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $2,509 | support | 0.8 | 6 |
| R2 | $2,547 | resistance | 1.0 | 5 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $100.23 | support | 0.7 | 2 |
| S2 | $99.43 | support | 0.8 | 4 |
| S3 | $98.97 | swing_low | 0.2 | 1 |
...
S/R levels sourced from the n0brains.com Signals Pro Levels API (`/levels/{coin}`). Computed from Hyperliquid L2 order book data. Strength = normalized score based on touch count, recency, and order book depth at that level. Data pulled at approximately 18:00 UTC on September 13, 2026.
