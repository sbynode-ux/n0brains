...
The n0brains Macro Pulse calls the regime **squeeze** with BTC bias **neutral** at **0.4 conviction**. Smart money is range-bound — waiting for a catalyst before committing directionally.
...
- **Regime**: squeeze — Low VIX and high net liquidity offset by rising real yields and a steepening curve, creating a squeeze environment.
- **BTC Bias**: neutral at 0.4 conviction
- **ETH Bias**: bullish at 0.3 conviction
- **Key Calendar Risks**: Potential shifts in real yield trajectory (real_y10), DXY volatility impacting liquidity flows
