---
title: "S/R Level Watch — May 23, 2026"
description: "BTC at $75,448, ETH at $2,063, SOL at $84.14. Key levels with strength scores and touch counts from n0brains.com Signals Pro."
pubDate: 2026-05-23
...
|-------|-------|------|----------|---------|
| R1 | $75,648 | resistance | 0.4 | 2 |
| R2 | $76,051 | swing_high | 0.2 | 1 |
| R3 | $77,084 | swing_high | 0.2 | 1 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $75,173 | swing_low | 0.2 | 1 |
| S2 | $74,615 | swing_low | 0.2 | 1 |
| S3 | $74,234 | swing_low | 0.2 | 1 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $2,069 | resistance | 0.6 | 3 |
| R2 | $2,079 | swing_high | 0.2 | 1 |
| R3 | $2,129 | resistance | 0.6 | 3 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $2,054 | support | 0.4 | 2 |
| S2 | $2,026 | swing_low | 0.2 | 1 |
| S3 | $2,008 | swing_low | 0.2 | 1 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $84.56 | resistance | 0.8 | 4 |
| R2 | $85.27 | swing_high | 0.2 | 1 |
| R3 | $86.32 | swing_high | 0.2 | 1 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $84.05 | support | 0.8 | 4 |
| S2 | $82.08 | swing_low | 0.2 | 1 |
| S3 | $81.45 | swing_low | 0.2 | 1 |
...
S/R levels sourced from the n0brains.com Signals Pro Levels API (`/levels/{coin}`). Computed from Hyperliquid L2 order book data. Strength = normalized score based on touch count, recency, and order book depth at that level. Data pulled at approximately 18:00 UTC on May 23, 2026.
