---
title: "S/R Level Watch — May 20, 2026"
description: "BTC at $77,494, ETH at $2,137, SOL at $86.40. Key levels with strength scores and touch counts from n0brains.com Signals Pro."
pubDate: 2026-05-20
...
|-------|-------|------|----------|---------|
| R1 | $77,713 | resistance | 1.0 | 5 |
| R2 | $78,447 | resistance | 0.4 | 2 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $77,160 | support | 0.6 | 3 |
| S2 | $76,647 | support | 1.0 | 14 |
| S3 | $76,095 | support | 0.6 | 3 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $2,139 | resistance | 1.0 | 6 |
| R2 | $2,147 | resistance | 0.4 | 2 |
| R3 | $2,156 | swing_high | 0.2 | 1 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $2,125 | support | 1.0 | 5 |
| S2 | $2,115 | support | 0.8 | 4 |
| S3 | $2,106 | support | 1.0 | 8 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $86.91 | resistance | 0.4 | 2 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $85.25 | swing_low | 0.2 | 1 |
| S2 | $84.60 | support | 1.0 | 8 |
| S3 | $84.04 | support | 1.0 | 9 |
...
S/R levels sourced from the n0brains.com Signals Pro Levels API (`/levels/{coin}`). Computed from Hyperliquid L2 order book data. Strength = normalized score based on touch count, recency, and order book depth at that level. Data pulled at approximately 18:00 UTC on May 20, 2026.
