---
title: "S/R Level Watch — June 20, 2026"
description: "BTC at $63,814, ETH at $1,726, SOL at $71.54. Key levels with strength scores and touch counts from n0brains.com Signals Pro."
pubDate: 2026-06-20
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $63,655 | swing_low | 0.2 | 1 |
| S2 | $63,270 | support | 0.6 | 3 |
| S3 | $62,819 | support | 0.8 | 4 |
...
| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| R1 | $1,732 | resistance | 0.4 | 2 |
| R2 | $1,751 | resistance | 1.0 | 5 |
| R3 | $1,762 | swing_high | 0.2 | 1 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $1,723 | support | 0.6 | 3 |
| S2 | $1,706 | support | 0.4 | 2 |
| S3 | $1,698 | support | 0.8 | 4 |
...
| R2 | $72.10 | resistance | 0.4 | 2 |
| R3 | $72.58 | resistance | 0.6 | 3 |

**Support Levels**

| Level | Price | Type | Strength | Touches |
|-------|-------|------|----------|---------|
| S1 | $71.30 | support | 0.4 | 2 |
| S2 | $70.63 | support | 0.8 | 4 |
| S3 | $69.46 | swing_low | 0.2 | 1 |
...
S/R levels sourced from the n0brains.com Signals Pro Levels API (`/levels/{coin}`). Computed from Hyperliquid L2 order book data. Strength = normalized score based on touch count, recency, and order book depth at that level. Data pulled at approximately 18:00 UTC on June 20, 2026.
